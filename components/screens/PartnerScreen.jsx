    ...
    <div style={{ height: "100%", display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "8px 16px 28px", display: "flex", flexDirection: "column", gap: 12 }}>
        ...
        <Card style={{ textAlign: "center" }}>
          ...
          <div style={{ fontFamily: "DM Sans,sans-serif", fontSize: 12, color: "rgba(var(--ink-rgb),0.6)", lineHeight: 1.6, marginTop: 4 }}>They'll see your current phase, days to next period and ovulation — nothing else. Revoke anytime.</div>
        </Card>
