        ...
        <Card style={{background:`linear-gradient(135deg,rgba(45,17,85,0.9),rgba(74,32,128,0.7))`}}>
          <div style={{display:"flex",alignItems:"center",gap:16}}>
            ...
            <div style={{flex:1}}>
              ...
              <div style={{fontFamily:"DM Sans,sans-serif",fontSize:11,color:"rgba(245,230,255,0.6)",lineHeight:1.6}}>{moderateCount} risk{moderateCount===1?"":"s"} above baseline, identified using biome + cycle data. Targeted actions could raise your protection score.</div>
            </div>
          </div>
        </Card>
        {risks.map((risk,i)=>(
